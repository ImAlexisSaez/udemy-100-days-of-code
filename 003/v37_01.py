...
true_in_couple = couple.count(
    'T') + couple.count('R') + couple.count('U') + couple.count('E')
love_in_couple = couple.count(
    'L') + couple.count('O') + couple.count('V') + couple.count('E')

score = 10 * true_in_couple + love_in_couple
